        ...
        for dropout_rate in dropout_rate_options:
            for batch_size in batch_size_options:
                for epochs in epochs_options:
                    print(f"Training with filters={filters}, kernel_size={kernel_size}, dropout_rate={dropout_rate}, batch_size={batch_size}, epochs={epochs}")
...
# 计算和绘制ALE图
ale_explainer = ALE(cnn_predict, feature_names=features)
